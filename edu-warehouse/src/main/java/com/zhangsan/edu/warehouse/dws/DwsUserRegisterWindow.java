...
import com.zhangsan.edu.warehouse.bean.DwsUserRegisterWindowBean;
import com.zhangsan.edu.warehouse.util.*;
...
public class DwsUserRegisterWindow {
    public static void main(String[] args) throws Exception {
        ...
        notNullStream.print("not null stream===");
        ...
        processSteam.print("process stream >>>>");
        // TODO 5 转换为javaBean
...
//        beanStream.print("bean stream bbbbb");
        ...
        // TODO 5 转换为javaBean
        SingleOutputStreamOperator<DwsUserRegisterWindowBean> beanStream = processSteam.map(jsonObj -> {
            String rowOpTs = jsonObj.getString("row_op_ts");
            Long eventTime = null;

            try {
                if (rowOpTs != null && !rowOpTs.isEmpty()) {
                    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS'Z'");
                    sdf.setTimeZone(java.util.TimeZone.getTimeZone("UTC"));
                    eventTime = sdf.parse(rowOpTs).getTime();
                    System.out.println("row_op_ts: " + rowOpTs + " eventTime: " + eventTime);
                }
            } catch (Exception e) {
                e.printStackTrace();
            ...
            if (eventTime == null) {
                eventTime = System.currentTimeMillis();
                System.out.println("eventTime null: " + eventTime);
            }
        ...
        withWaterMarkStream.print("with water mark stream ---");
        // TODO 7 开窗聚合
